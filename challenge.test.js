...
const isSimilar = (arr) => {
    // Solution code here...
// let stringone = arr[0].split('');
// let stringtwo = arr[1].split('');

let inc = arr.reduce(acc,element1, index =>{
    acc.reduce(acc2,element2 ,index2=>{
       return acc[index].includes(acc2[index2])
    })
},0)
return inc;
